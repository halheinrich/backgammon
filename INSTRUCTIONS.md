...
Key files:
- XgFilter_Lib.csproj: https://raw.githubusercontent.com/halheinrich/XgFilter_Lib/4af20df/XgFilter_Lib/XgFilter_Lib.csproj
...
**Repo:** https://github.com/halheinrich/BackgammonDiagram_Lib (to be created)
**Branch:** main
...
Key files:
- BackgammonDiagram_Lib.csproj: https://raw.githubusercontent.com/halheinrich/BackgammonDiagram_Lib/fbfdf4a/BackgammonDiagram_Lib/BackgammonDiagram_Lib.csproj
...
| Subproject | Status |
|---|---|
| ConvertXgToJson_Lib | ✅ Complete — XGID encoding always normalized to bottom-player perspective. XgIteratorState early-exit mechanism in place. XgMatchInfo and XgGameInfo added. XgFileReader.ReadMatchInfo and ReadGameHeaders added. All tests pass. |
| XgFilter_Lib | ✅ Complete — all filters, classifiers, ColumnSelector, FilteredDecisionIterator, full test suite passing; TestData path updated to shared location; IMatchFilter added; early-exit optimization in place; InnerBoard631Classifier added |
...
- ConvertXgToJson_Lib needs a `ReadMatchInfo` short-circuit method to speed up file scanning (identified from XgAnalytics) ✅ done at `db279df`
...
- XgFilter_Lib is server-side only
...
This applies in all subproject Claude Projects as well. Each subproject instructions doc includes the same note.
